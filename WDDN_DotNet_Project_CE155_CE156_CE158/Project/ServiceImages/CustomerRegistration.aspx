<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CustomerRegistration.aspx.cs" Inherits="Project.WebForm1" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Gender</label>
                                <div class="form-group">
                                    <asp:RadioButtonList ID="RadioButtonGender" runat="server" CssClass="form-control">
